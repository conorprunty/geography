...
namespace Geography.Controllers
{
    public class CountryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CountryId,Name,Population")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CountryId,Name,Population")] Country country)
        {
            if (ModelState.IsValid)
            {
