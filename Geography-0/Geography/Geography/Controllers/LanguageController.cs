...
namespace Geography.Controllers
{
    public class LanguageController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LanguageId,Name,NumberOfUsers")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LanguageId,Name,NumberOfUsers")] Language language)
        {
            if (ModelState.IsValid)
            {
