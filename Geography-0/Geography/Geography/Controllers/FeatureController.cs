...
namespace Geography.Controllers
{
    public class FeatureController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FeatureId,Name,Location,Height")] Feature feature)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FeatureId,Name,Location,Height")] Feature feature)
        {
            if (ModelState.IsValid)
            {
